...
class LeNet_alt10(Chain):
	def __init__(self):
		super(LeNet_alt10, self).__init__()
		self.output = {}
		with self.init_scope():
			self.conv1 = L.Convolution2D(1, 25, 9)
			self.conv2 = L.Convolution2D(25, 50, 9)
			self.affine1 = L.Linear(50, 50)
			self.affine2 = L.Linear(50, 10)
