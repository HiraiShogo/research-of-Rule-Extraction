...
from networks.LeNet_alt10 import LeNet_alt10 as DNN  # @UnresolvedImport
...
class Model:
    ...
    def train_Network(self, n_in, n_units, n_out, gd=0, e=50, bs=100, f=-1, path=""):
        ...
        trainer = training.Trainer(updater, (self.params["e"], 'epoch'), out=path)
