...
class LeNet_alt9(Chain):
	def __init__(self):
		super(LeNet_alt9, self).__init__()
		self.output = {}
		with self.init_scope():
			self.conv1 = L.Convolution2D(1, 22, 9)
			self.conv2 = L.Convolution2D(22, 45, 9)
			self.affine1 = L.Linear(45, 45)
			self.affine2 = L.Linear(45, 10)
