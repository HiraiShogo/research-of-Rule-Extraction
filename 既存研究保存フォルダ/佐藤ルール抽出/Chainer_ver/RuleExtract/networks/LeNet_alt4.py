...
class LeNet_alt4(Chain):
	def __init__(self):
		super(LeNet_alt4, self).__init__()
		self.output = {}
		with self.init_scope():
			self.conv1 = L.Convolution2D(1, 15, 9)
			self.conv2 = L.Convolution2D(15, 30, 9)
			self.affine1 = L.Linear(30, 30)
			self.affine2 = L.Linear(30, 10)
