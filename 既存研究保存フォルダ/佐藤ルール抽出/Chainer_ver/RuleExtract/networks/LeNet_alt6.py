...
class LeNet_alt6(Chain):
	def __init__(self):
		super(LeNet_alt6, self).__init__()
		self.output = {}
		with self.init_scope():
			self.conv1 = L.Convolution2D(1, 20, 9)
			self.conv2 = L.Convolution2D(20, 40, 9)
			self.affine1 = L.Linear(40, 40)
			self.affine2 = L.Linear(40, 10)
