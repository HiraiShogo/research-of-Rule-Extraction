...
class LeNet_alt3(Chain):
	def __init__(self):
		super(LeNet_alt3, self).__init__()
		self.output = {}
		with self.init_scope():
			self.conv1 = L.Convolution2D(1, 10, 9)
			self.conv2 = L.Convolution2D(10, 25, 9)
			self.affine1 = L.Linear(25, 25)
			self.affine2 = L.Linear(25, 10)
